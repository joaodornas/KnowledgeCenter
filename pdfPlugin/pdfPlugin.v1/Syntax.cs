...
namespace pdfPlugin
{
    ...
    public class Syntax
    {
       ...
       */
        ...
        //7.5 File Structure [TO BE FINISHED!!]
        public class File_Structure
        {
            ...
            */
            ...
            //7.5.4 Cross-Reference Table [DONE!! - CHECK FOR ERRORS!!]
            public void Cross_Reference_Table(ref Globals globals)
            {
                ...
                int xref_offset = globals.PDF_Trailer.byte_offset_of_last_cross_reference_section.value;

                string xref_line_hexa = Tools.getLineFromByteOffset(ref globals.PDF_File.pdf_stream_hexa, xref_offset * 3, LF);
                string xref_line_string = Tools.lineHexToString(xref_line_hexa);

                int xref_line_hexa_offset = 0;

                int TotalObjects = globals.PDF_Properties.nObjects;

                ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                /// EXTRACT OBJECT INFORMATION, ONE PER LINE, FROM CROSS REFERENCE TABLE
                ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    xref_line_hexa_offset = xref_line_hexa_offset + xref_line_hexa.Length + 3;

                    xref_line_hexa = Tools.getLineFromByteOffset(ref globals.PDF_File.pdf_stream_hexa, (xref_offset * 3) + xref_line_hexa_offset, LF);
                    xref_line_string = Tools.lineHexToString(xref_line_hexa);

                    string[] keys = xref_line_string.Split(' ');
                    ...
                    if (keys.Length == 2)
                    {
                        ...
                        for (int i = 0; i < nObjectsInSection; i++)
                        {
                            xref_line_hexa_offset = xref_line_hexa_offset + xref_line_hexa.Length + 3;
                            ...
                            string[] keys_obj = xref_line_string.Split(' ');

                            globals.PDF_Cross_Reference_Table[startObject + i].byte_offset = Convert.ToInt32(keys_obj[0]);
                            globals.PDF_Cross_Reference_Table[startObject + i].generation_number = Convert.ToInt32(keys_obj[1]);

                            Boolean in_use = false;
                            if (String.Compare(keys_obj[2], "f") == 0)
                            {
                                in_use = false;
                            }
                            else if (String.Compare(keys_obj[2], "n") == 0)
                            {
                                in_use = true;
                            }

                            globals.PDF_Cross_Reference_Table[startObject + i].in_use = in_use;

                            globals.PDF_Cross_Reference_Table[startObject + i].global_object_idx = startObject + i + 1;
                            globals.PDF_Cross_Reference_Table[startObject + i].local_object_idx = i + 1;
                            globals.PDF_Cross_Reference_Table[startObject + i].subsection_idx = subsectionIdx;


                        }

                        TotalObjects = TotalObjects - nObjectsInSection;
            ...
            //7.5.5 File Trailer [DONE!! - CHECK FOR ERRORS!!]
            public void File_Trailer(ref Globals globals)
            {
                ...
                int eof_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(EOF), 0);

                int startxref_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(keyword_startxref), 0);

                string byte_offset_hexa = globals.PDF_File.pdf_stream_hexa.Substring(startxref_idx, eof_idx - startxref_idx);

                int[] lf_idxs = new int[2];

                lf_idxs[0] = byte_offset_hexa.IndexOf(LF, 0);
                lf_idxs[1] = byte_offset_hexa.IndexOf(LF, lf_idxs[0] + 1);

                string byte_offset_string = Tools.lineHexToString(byte_offset_hexa.Substring(lf_idxs[0] + 3, lf_idxs[1] - lf_idxs[0] - 3));

                globals.PDF_Trailer.byte_offset_of_last_cross_reference_section.value = Convert.ToInt32(byte_offset_string);

                globals.PDF_Trailer.byte_offset_of_last_cross_reference_section.found = true;
                ...
                int trailer_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(keyword_trailer));
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.Size.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.Size.found = true;

                    Tools.getIntegerInDictionaryHex(ref globals.PDF_Trailer.Size.value, ref globals.PDF_File.pdf_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Trailer.Size.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    globals.PDF_Properties.nObjects = globals.PDF_Trailer.Size.value;
                }
                else
                {
                    globals.PDF_Trailer.Size.found = false;
                }
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.Root.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.Root.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Trailer.Root.value, ref globals.PDF_File.pdf_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Trailer.Root.key).Length, ref ERROR_ID, ref ERROR_MSG);

                }
                else
                {
                    globals.PDF_Trailer.Root.found = false;
                }
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.Info.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.Info.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Trailer.Info.value, ref globals.PDF_File.pdf_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Trailer.Info.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Trailer.Info.found = false;
                }
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.Prev.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.Prev.found = true;
                }
                else
                {
                    globals.PDF_Trailer.Prev.found = false;
                }
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.Encrypt.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.Encrypt.found = true;
                }
                else
                {
                    globals.PDF_Trailer.Encrypt.found = false;
                }
                ...
                key_idx = globals.PDF_File.pdf_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Trailer.ID.key), trailer_idx);

                if (key_idx != -1)
                {
                    globals.PDF_Trailer.ID.found = true;
                }
                else
                {
                    globals.PDF_Trailer.ID.found = false;
                }
                ...
                if ((globals.PDF_Trailer.Size.found == false) && (globals.PDF_Trailer.Size.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Trailer.Root.found == false) && (globals.PDF_Trailer.Root.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Trailer.Info.found == false) && (globals.PDF_Trailer.Info.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Trailer.Prev.found == false) && (globals.PDF_Trailer.Prev.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Trailer.Encrypt.found == false) && (globals.PDF_Trailer.Encrypt.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Trailer.ID.found == false) && (globals.PDF_Trailer.ID.required == true))
                {
                    //REGISTER ERROR
                }
        ...
        {
            public PDF_Encryption Main_Encryption(string[] key_value)
            {

                PDF_Encryption encryption = new PDF_Encryption();
        ...
        public class Document_Structure
        {
            ...
            */
            ...
            public void Document_Catalog(ref Globals globals)
            {
                ...
                */
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                /// CHECK THAT WE HAVE THE DOCUMENT CATALOG DICTIONARY IN THIS OBJECT
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                
                int obj_idx = Convert.ToInt32(globals.PDF_Trailer.Root.value[0]);

                int offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset * 3;

                string obj_stream_hexa = Tools.getOBJstream(ref globals.PDF_File.pdf_stream_hexa, offset);

                offset = 0;

                int type_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Type.key), offset);

                int name_idx = obj_stream_hexa.IndexOf(SL, type_idx + 1);
                ...
                if (String.Compare(name_string, globals.PDF_Document_Catalog.Type.value) != 0)
                {
                    // ERROR - IT FOUND THE WRONG DICTIONARY
                }

                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                /// GET EACH ITEM FROM DOCUMENT CATALOG DICTIONARY
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Version.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Version.found = true;

                    Tools.getNameInDictionaryHex(ref globals.PDF_Document_Catalog.Version.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Version.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.Version.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Extensions (dictionary) 7.12, “Extensions Dictionary”,
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Extensions.key), offset);
                ...
                if (key_idx != -1)
                {
                    ...
                    globals.PDF_Document_Catalog.Extensions.found = true;

                    Syntax.Extensions_Dictionary extensions_dictionary = new Syntax.Extensions_Dictionary();

                    extensions_dictionary.getExtensionsDictionary(ref globals, ref globals.PDF_Document_Catalog.Extensions.value, ref obj_stream_hexa, key_idx);

                }
                else
                {
                    globals.PDF_Document_Catalog.Extensions.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Pages (dictionary) shall be an indirect reference
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Pages.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Pages.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Document_Catalog.Pages.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Pages.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    Syntax.Document_Structure.Page_Tree page_tree = new Syntax.Document_Structure.Page_Tree();

                    page_tree.getPageTree(ref globals);

                    int nPages = globals.PDF_Page_Tree.Count.value;

                    for (int i = 0; i < nPages; i++)
                    {
                        PDF_Page_Object pdf_page_object = new PDF_Page_Object(true);

                        string[] keys = globals.PDF_Page_Tree.Kids.value[i];

                        int page_offset = globals.PDF_Cross_Reference_Table[Convert.ToInt32(keys[0])].byte_offset * 3;

                        page_tree.getPageObjects(ref globals, ref pdf_page_object, ref globals.PDF_File.pdf_stream_hexa, page_offset);

                        globals.PDF_Pages.Add(pdf_page_object);
                    }

                }
                else
                {
                    globals.PDF_Document_Catalog.Pages.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /PageLabels (number tree) 7.9.7, "Number Trees"
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.PageLabels.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.PageLabels.found = true;

                    Syntax.Common_Data_Structures common_data_structures = new Syntax.Common_Data_Structures();

                    common_data_structures.getNumberTreeNodeDictionary(ref globals.PDF_Document_Catalog.PageLabels.value_x, ref obj_stream_hexa, key_idx);

                    Interactive_Features.Page_Level_Navigation page_level_navigation = new Interactive_Features.Page_Level_Navigation();

                    page_level_navigation.getPageLabelsDictionary(ref globals.PDF_Document_Catalog.PageLabels.value_y, ref globals.PDF_Document_Catalog.PageLabels.value_x);
                }
                else
                {
                    globals.PDF_Document_Catalog.PageLabels.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Names (dictionary) 7.7.4, "Name Dictionary"
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Names.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Names.found = true;

                    this.Name_Dictionary(ref globals, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.Names.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Dests (dictionary) shall be an indirect reference
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Dests.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Dests.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Document_Catalog.Dests.value_x, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Dests.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    int idx = Convert.ToInt32(globals.PDF_Document_Catalog.Dests.value_x[0]);

                    int obj_offset = globals.PDF_Cross_Reference_Table[idx].byte_offset * 3;

                    Interactive_Features.Document_Level_Navigation document_level_navigation = new Interactive_Features.Document_Level_Navigation();

                    document_level_navigation.getNamedDestinations(ref globals.PDF_Document_Catalog.Dests.value_y, ref globals.PDF_File.pdf_stream_hexa, obj_offset);


                }
                else
                {
                    globals.PDF_Document_Catalog.Dests.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /ViewerPreferences (dictionary) 12.2, "Viewer Preferences"
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.ViewerPreferences.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.ViewerPreferences.found = true;

                    Interactive_Features.Viewer_Preferences viewer_preferences = new Interactive_Features.Viewer_Preferences();

                    viewer_preferences.getViewerPreferencesDictionary(ref globals.PDF_Document_Catalog.ViewerPreferences.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.ViewerPreferences.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.PageLayout.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.PageLayout.found = true;

                    Tools.getNameInDictionaryHex(ref globals.PDF_Document_Catalog.PageLayout.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.PageLayout.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.PageLayout.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.PageMode.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.PageMode.found = true;

                    Tools.getNameInDictionaryHex(ref globals.PDF_Document_Catalog.PageMode.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.PageMode.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.PageMode.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Outlines (dictionary) shall be an indirect reference
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Outlines.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Outlines.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Document_Catalog.Outlines.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Outlines.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.Outlines.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Threads.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Threads.found = true;

                    Tools.getArrayInDictionaryHex(ref globals.PDF_Document_Catalog.Threads.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Threads.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.Threads.found = false;
                }

                ////////////////////////////////////////////////////////////////////////////////////
                /// /OpenAction [array (12.3.2, "Destinations") or dictionary (12.6, "Actions")]
                ////////////////////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.OpenAction.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.OpenAction.found = true;

                    int idx_kind_obj = Tools.identifyObject(ref globals, ref obj_stream_hexa, key_idx);

                    if (idx_kind_obj == globals.Kinds_of_Objects.Array)
                    {
                        globals.PDF_Document_Catalog.OpenAction.kind_of_obj = globals.Kinds_of_Objects.Array;

                        Tools.getArrayInDictionaryHex(ref globals.PDF_Document_Catalog.OpenAction.value_x, ref globals.PDF_File.pdf_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.OpenAction.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    }
                    else if (idx_kind_obj == globals.Kinds_of_Objects.Dictionary)
                    {
                        globals.PDF_Document_Catalog.OpenAction.kind_of_obj = globals.Kinds_of_Objects.Dictionary;

                        Interactive_Features.Actions actions = new Interactive_Features.Actions();

                        actions.getActionDictionaryforDocumentCatalog(ref globals, key_idx);
                ...
                {
                    globals.PDF_Document_Catalog.OpenAction.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /AA (dictionary) (see 12.6.3, "Trigger Events")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.AA.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.AA.found = true;

                    Interactive_Features.Actions actions = new Interactive_Features.Actions();

                    actions.getTriggerEventsDictionaryforDocumentCatalog(ref globals, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.AA.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /URI (dictionary) (see 12.6.4.7, "URI Actions")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.URI.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.URI.found = true;

                    Interactive_Features.Actions actions = new Interactive_Features.Actions();

                    actions.getURIActionsDictionaryforDocumentCatalog(ref globals, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.URI.found = false;
                }

                //////////////////////////////////////////////////////////////////////////
                /// /AcronForm (dictionary) (see 12.7.2, "Interactive Form Dictionary")
                //////////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.AcronForm.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.AcronForm.found = true;

                    Interactive_Features.Interactive_Forms interactive_forms = new Interactive_Features.Interactive_Forms();

                    interactive_forms.getInteractiveFormDictionary(ref globals.PDF_Document_Catalog.AcronForm.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.AcronForm.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Metadata.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Metadata.found = true;

                    Tools.getStreamInDictionaryHex(ref globals.PDF_Document_Catalog.Metadata.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Metadata.key).Length, ref ERROR_ID, ref ERROR_MSG);

                }
                else
                {
                    globals.PDF_Document_Catalog.Metadata.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /StructTreeRoot (dictionary) (see 14.7.2, "Structure Hierarchy")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.StructTreeRoot.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.StructTreeRoot.found = true;

                    Document_Interchange.Logical_Structure logical_structure = new Document_Interchange.Logical_Structure();

                    logical_structure.getStructureTreeRootDictionary(ref globals.PDF_Document_Catalog.StructTreeRoot.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.StructTreeRoot.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /MarkInfo (dictionary) (see 14.7, "Logical Structure")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.MarkInfo.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.MarkInfo.found = true;

                    Document_Interchange.Logical_Structure logical_structure = new Document_Interchange.Logical_Structure();

                    logical_structure.getMarkInformationDictionary(ref globals.PDF_Document_Catalog.MarkInfo.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.MarkInfo.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Lang.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Lang.found = true;

                    Tools.getStringInDictionaryHex(ref globals.PDF_Document_Catalog.Lang.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Lang.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.Lang.found = false;
                }

                /////////////////////////////////////////////////////////////////////////////////////
                /// /SpiderInfo (dictionary) (see 14.10.2, "Web Capture Information Dictionary")
                /////////////////////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.SpiderInfo.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.SpiderInfo.found = true;

                    Document_Interchange.Web_Capture web_capture = new Document_Interchange.Web_Capture();

                    web_capture.getWebCaptureInformationDictionary(ref globals.PDF_Document_Catalog.SpiderInfo.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.SpiderInfo.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.OutputIntents.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.OutputIntents.found = true;

                    Tools.getArrayInDictionaryHex(ref globals.PDF_Document_Catalog.OutputIntents.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.OutputIntents.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.OutputIntents.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /PieceInfo (dictionary) (see 14.5, "Page-Piece Dictionaries")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.PieceInfo.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.PieceInfo.found = true;

                    Document_Interchange.Page_Piece_Dictionaries page_piece_dictionaries = new Document_Interchange.Page_Piece_Dictionaries();

                    page_piece_dictionaries.getPagePieceDictionary(ref globals.PDF_Document_Catalog.PieceInfo.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.PieceInfo.found = false;
                }

                //////////////////////////////////////////////////////////////////////////////
                /// /OCProperties (dictionary) (see 8.11.4, "Configuring Optional Content")
                //////////////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.OCProperties.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.OCProperties.found = true;

                    Graphics.Optional_Content optional_content = new Graphics.Optional_Content();

                    optional_content.getOptionalContentPropertiesDictionary(ref globals.PDF_Document_Catalog.OCProperties.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.OCProperties.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Perms (dictionary) 12.8.4, "Permissions"
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Perms.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Perms.found = true;

                    Interactive_Features.Digital_Signatures digital_signatures = new Interactive_Features.Digital_Signatures();

                    digital_signatures.getPermissionsDictionary(ref globals.PDF_Document_Catalog.Perms.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.Perms.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Legal (dictionary) 12.8.5, "Legal Content Attestations"
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Legal.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Legal.found = true;

                    Interactive_Features.Digital_Signatures digital_signatures = new Interactive_Features.Digital_Signatures();

                    digital_signatures.getLegalAttestationsDictioanry(ref globals.PDF_Document_Catalog.Legal.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.Legal.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Requirements.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Requirements.found = true;

                    Tools.getArrayInDictionaryHex(ref globals.PDF_Document_Catalog.Requirements.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.Requirements.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.Requirements.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Collection (dictionary) (see 12.3.5, "Collections")
                ///////////////////////////////////////////////////////////////////////

                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.Collection.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.Collection.found = true;

                    Interactive_Features.Document_Level_Navigation document_level_navigation = new Interactive_Features.Document_Level_Navigation();

                    document_level_navigation.getCollectionDictionary(ref globals.PDF_Document_Catalog.Collection.value, ref obj_stream_hexa, key_idx);
                }
                else
                {
                    globals.PDF_Document_Catalog.Collection.found = false;
                }
                ...
                key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Document_Catalog.NeedsRendering.key), offset);
                ...
                if (key_idx != -1)
                {
                    globals.PDF_Document_Catalog.NeedsRendering.found = true;

                    Tools.getBooleanInDictionaryHex(ref globals.PDF_Document_Catalog.NeedsRendering.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Document_Catalog.NeedsRendering.key).Length, ref ERROR_ID, ref ERROR_MSG);
                }
                else
                {
                    globals.PDF_Document_Catalog.NeedsRendering.found = false;
                }
                ...
                if ((globals.PDF_Document_Catalog.Version.found == false) && (globals.PDF_Document_Catalog.Version.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Extensions.found == false) && (globals.PDF_Document_Catalog.Extensions.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Pages.found == false) && (globals.PDF_Document_Catalog.Pages.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.PageLabels.found == false) && (globals.PDF_Document_Catalog.PageLabels.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Names.found == false) && (globals.PDF_Document_Catalog.Names.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Dests.found == false) && (globals.PDF_Document_Catalog.Dests.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.ViewerPreferences.found == false) && (globals.PDF_Document_Catalog.ViewerPreferences.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.PageLayout.found == false) && (globals.PDF_Document_Catalog.PageLayout.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.PageMode.found == false) && (globals.PDF_Document_Catalog.PageMode.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Outlines.found == false) && (globals.PDF_Document_Catalog.Outlines.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Threads.found == false) && (globals.PDF_Document_Catalog.Threads.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.OpenAction.found == false) && (globals.PDF_Document_Catalog.OpenAction.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.AA.found == false) && (globals.PDF_Document_Catalog.AA.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.URI.found == false) && (globals.PDF_Document_Catalog.URI.required == true))
                {
                    //REGISTER ERROR
                }

                ///////////////////////////////////////////////////////////////////////
                /// /AcronForm (dictionary)
                ///////////////////////////////////////////////////////////////////////

                if ((globals.PDF_Document_Catalog.AcronForm.found == false) && (globals.PDF_Document_Catalog.AcronForm.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Metadata.found == false) && (globals.PDF_Document_Catalog.Metadata.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.StructTreeRoot.found == false) && (globals.PDF_Document_Catalog.StructTreeRoot.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.MarkInfo.found == false) && (globals.PDF_Document_Catalog.MarkInfo.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Lang.found == false) && (globals.PDF_Document_Catalog.Lang.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.SpiderInfo.found == false) && (globals.PDF_Document_Catalog.SpiderInfo.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.OutputIntents.found == false) && (globals.PDF_Document_Catalog.OutputIntents.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.PieceInfo.found == false) && (globals.PDF_Document_Catalog.PieceInfo.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.OCProperties.found == false) && (globals.PDF_Document_Catalog.OCProperties.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Perms.found == false) && (globals.PDF_Document_Catalog.Perms.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Legal.found == false) && (globals.PDF_Document_Catalog.Legal.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Requirements.found == false) && (globals.PDF_Document_Catalog.Requirements.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.Collection.found == false) && (globals.PDF_Document_Catalog.Collection.required == true))
                {
                    //REGISTER ERROR
                }
                ...
                if ((globals.PDF_Document_Catalog.NeedsRendering.found == false) && (globals.PDF_Document_Catalog.NeedsRendering.required == true))
                {
                    //REGISTER ERROR
                }
            ...
            public class Page_Tree
            {
                ...
                */
                ...
                public void getPageTree(ref Globals globals)
                {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    /// CHECK THAT WE HAVE THE PAGES DICTIONARY IN THIS OBJECT
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////

                    int obj_idx = Convert.ToInt32(globals.PDF_Document_Catalog.Pages.value[0]);
                    ...
                    int type_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Page_Tree.Type.key), offset);
                    ...
                    if (String.Compare(name_string, globals.PDF_Page_Tree.Type.value) != 0)
                    {
                        // ERROR - IT FOUND THE WRONG DICTIONARY
                    }

                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    /// GET EACH ITEM FROM PAGES DICTIONARY
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Page_Tree.Parent.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        globals.PDF_Page_Tree.Parent.found = true;

                        Tools.getIndirectDictionaryInDictionaryHex(ref globals.PDF_Page_Tree.Parent.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Page_Tree.Parent.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        globals.PDF_Page_Tree.Parent.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Page_Tree.Kids.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        globals.PDF_Page_Tree.Kids.found = true;

                        Tools.getIndirectDictionaryArrayInDictionaryHex(ref globals.PDF_Page_Tree.Kids.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Page_Tree.Kids.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        globals.PDF_Document_Catalog.Version.found = false;
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(globals.PDF_Page_Tree.Count.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        globals.PDF_Page_Tree.Count.found = true;

                        Tools.getIntegerInDictionaryHex(ref globals.PDF_Page_Tree.Count.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(globals.PDF_Page_Tree.Count.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        globals.PDF_Page_Tree.Count.found = false;
                    }
                ...
                */
                ...
                public void getPageObjects(ref Globals globals, ref PDF_Page_Object pdf_page_object, ref string stream_hexa, int offset)
                {
                    /////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    /// CHECK THAT WE HAVE A PAGE OBJECT DICTIONARY IN THIS OBJECT
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    int type_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Type.key), offset);
                    ...
                    if (String.Compare(name_string, pdf_page_object.Type.value) != 0)
                    {
                        // ERROR - IT FOUND THE WRONG DICTIONARY
                    }
                    ...
                    /////////////////////////////////////////////////////////////////////////////////////////////////
                    /// /Parent (dictionary, shall be an indirect reference)
                    /////////////////////////////////////////////////////////////////////////////////////////////////

                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Parent.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Parent.found = true;

                        Tools.getIndirectDictionaryInDictionaryHex(ref pdf_page_object.Parent.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Parent.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Parent.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.LastModified.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.LastModified.found = true;

                        Tools.getDateInDictionaryHex(ref pdf_page_object.LastModified.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.LastModified.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.LastModified.found = false;
                    }

                    /////////////////////////////////////////////////////////////////////////////////////////////////
                    /// /Resources (dictionary) (see 7.8.3, "Resource Dictionaries")
                    /////////////////////////////////////////////////////////////////////////////////////////////////

                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Resources.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Resources.found = true;

                        Content_Streams_and_Resources contents_streams_and_resources = new Content_Streams_and_Resources();

                        contents_streams_and_resources.getResourceDictionaries(ref globals, ref pdf_page_object.Resources.value, ref obj_stream_hexa, key_idx);
                    }
                    else
                    {
                        pdf_page_object.Resources.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.MediaBox.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.MediaBox.found = true;

                        Tools.getMatrixInDictionaryHex(ref pdf_page_object.MediaBox.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.MediaBox.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.MediaBox.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.CropBox.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.CropBox.found = true;

                        Tools.getMatrixInDictionaryHex(ref pdf_page_object.CropBox.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.CropBox.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.CropBox.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.BleedBox.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.BleedBox.found = true;

                        Tools.getMatrixInDictionaryHex(ref pdf_page_object.BleedBox.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.BleedBox.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.BleedBox.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.TrimBox.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.TrimBox.found = true;

                        Tools.getMatrixInDictionaryHex(ref pdf_page_object.TrimBox.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.TrimBox.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.TrimBox.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.ArtBox.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.ArtBox.found = true;

                        Tools.getMatrixInDictionaryHex(ref pdf_page_object.ArtBox.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.ArtBox.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.ArtBox.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.BoxColorInfo.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Type.found = true;

                        Document_Interchange.Prepress_Support prepress_support = new Document_Interchange.Prepress_Support();

                        prepress_support.getPDFBoxStyleDictionary(ref pdf_page_object.BoxColorInfo.value, ref obj_stream_hexa, key_idx);

                    }
                    else
                    {
                        pdf_page_object.Type.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Contents.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Contents.found = true;

                        int obj_idx = Tools.identifyObject(ref globals, ref obj_stream_hexa, key_idx);

                        if (obj_idx == globals.Kinds_of_Objects.Stream)
                        {
                            pdf_page_object.Contents.kind_of_obj = globals.Kinds_of_Objects.Stream;

                            Tools.getStreamInDictionaryHex(ref pdf_page_object.Contents.value_x, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Contents.key).Length, ref ERROR_ID, ref ERROR_MSG);
                        }
                        else if (obj_idx == globals.Kinds_of_Objects.Array)
                        {
                            pdf_page_object.Contents.kind_of_obj = globals.Kinds_of_Objects.Array;

                            Tools.getArrayInDictionaryHex(ref pdf_page_object.Contents.value_y, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Contents.key).Length, ref ERROR_ID, ref ERROR_MSG);
                        }
                        else
                        {
                            //throw error
                    ...
                    {
                        pdf_page_object.Contents.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Rotate.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Rotate.found = true;

                        Tools.getIntegerInDictionaryHex(ref pdf_page_object.Rotate.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Rotate.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Rotate.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Group.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        ...
                        Transparency.Transparency_Groups transparency_groups = new Transparency.Transparency_Groups();

                        transparency_groups.getTransparencyGroupXObject(ref pdf_page_object.Group.value, ref obj_stream_hexa, key_idx);
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Thumb.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Thumb.found = true;

                        Tools.getStreamInDictionaryHex(ref pdf_page_object.Thumb.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Thumb.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Thumb.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.B.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.B.found = true;

                        Tools.getArrayInDictionaryHex(ref pdf_page_object.B.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.B.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.B.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Dur.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Dur.found = true;

                        Tools.getNumberInDictionaryHex(ref pdf_page_object.Dur.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Dur.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Dur.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Trans.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Trans.found = true;

                        Interactive_Features.Page_Level_Navigation page_level_navigation = new Interactive_Features.Page_Level_Navigation();

                        page_level_navigation.getTransitionDictionaryy(ref pdf_page_object.Trans.value, ref obj_stream_hexa, key_idx);

                    }
                    else
                    {
                        pdf_page_object.Trans.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Annots.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Annots.found = true;

                        Tools.getArrayInDictionaryHex(ref pdf_page_object.Annots.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Type.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Annots.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.AA.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.AA.found = true;

                        Interactive_Features.Actions actions = new Interactive_Features.Actions();

                        actions.getTriggerEventsAdditionalActionsDictionaryForPageObject(ref pdf_page_object.AA.value, ref obj_stream_hexa, key_idx);

                    }
                    else
                    {
                        pdf_page_object.AA.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Metadata.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Metadata.found = true;

                        Tools.getStreamInDictionaryHex(ref pdf_page_object.Metadata.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Type.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Metadata.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.PieceInfo.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.PieceInfo.found = true;

                        Document_Interchange.Page_Piece_Dictionaries page_piece_dictionaries = new Document_Interchange.Page_Piece_Dictionaries();

                        page_piece_dictionaries.getPagePieceDictionary(ref pdf_page_object.PieceInfo.value, ref obj_stream_hexa, key_idx);
                    }
                    else
                    {
                        pdf_page_object.PieceInfo.found = false;
                    }
                    ...
                    key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.StructParents.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.StructParents.found = true;

                        Tools.getIntegerInDictionaryHex(ref pdf_page_object.StructParents.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.StructParents.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.StructParents.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.ID.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.ID.found = true;

                        Tools.getStringInDictionaryHex(ref pdf_page_object.ID.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Type.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.ID.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.PZ.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.PZ.found = true;

                        Tools.getNumberInDictionaryHex(ref pdf_page_object.PZ.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Type.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.PZ.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.SeparationInfo.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.SeparationInfo.found = true;

                        Document_Interchange.Prepress_Support prepress_support = new Document_Interchange.Prepress_Support();

                        prepress_support.getPDFSeparationDictionary(ref pdf_page_object.SeparationInfo.value, ref obj_stream_hexa, key_idx);


                    }
                    else
                    {
                        pdf_page_object.SeparationInfo.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.Tabs.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.Tabs.found = true;

                        Tools.getNameInDictionaryHex(ref pdf_page_object.Tabs.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.Tabs.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.Tabs.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.TemplateInstantiated.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.TemplateInstantiated.found = true;

                        Tools.getNameInDictionaryHex(ref pdf_page_object.TemplateInstantiated.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.TemplateInstantiated.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.TemplateInstantiated.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.PresSteps.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.PresSteps.found = true;


                        Interactive_Features.Page_Level_Navigation page_level_navigation = new Interactive_Features.Page_Level_Navigation();
                    
                        page_level_navigation.getNavigationNodeDictionary(ref pdf_page_object.PresSteps.value, ref obj_stream_hexa, key_idx);

                    }
                    else
                    {
                        pdf_page_object.PresSteps.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.UserUnit.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.UserUnit.found = true;

                        Tools.getNumberInDictionaryHex(ref pdf_page_object.UserUnit.value, ref obj_stream_hexa, key_idx, Tools.lineStringToHex(pdf_page_object.UserUnit.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    }
                    else
                    {
                        pdf_page_object.UserUnit.found = false;
                    }
                    ...
                    key_idx = obj_stream_hexa.IndexOf(Tools.lineStringToHex(pdf_page_object.VP.key), offset);
                    ...
                    if (key_idx != -1)
                    {
                        pdf_page_object.VP.found = true;

                        Interactive_Features.Measurement_Properties measurement_properties = new Interactive_Features.Measurement_Properties();

                        measurement_properties.getViewPortDictionary(ref pdf_page_object.VP.value, ref obj_stream_hexa, key_idx);

                    }
                    else
                    {
                        pdf_page_object.VP.found = false;
                    }
            ...
            public void Name_Dictionary(ref Globals globals, int offset)
            {
        ...
        public class Content_Streams_and_Resources
        {
            ...
            */
            ...
            public void getResourceDictionaries(ref Globals globals, ref PDF_Resources_Dictionary pdf_resources_dictionary, ref string stream_hexa, int offset)
            {
                ...
                ///////////////////////////////////////////////////////////////////////////////////
                /// /ExtGState (dictionary) (see 8.4.5, "Graphics State Parameter Dictionaries")
                ///////////////////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.ExtGState.key), offset);
                ...
                if (key_idx != -1)
                {
                    ...
                    pdf_resources_dictionary.ExtGState.found = true;

                    Tools.getIndirectDictionaryInDictionaryHex(ref pdf_resources_dictionary.ExtGState.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.ExtGState.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    
                    int resource_offset = globals.PDF_Cross_Reference_Table[Convert.ToInt32(pdf_resources_dictionary.ExtGState.value_x[0])].byte_offset * 3;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.ExtGState.value_y, ref globals.PDF_File.pdf_stream_hexa, resource_offset, Tools.lineStringToHex(pdf_resources_dictionary.ExtGState.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    foreach (KeyValuePair<string, string[]> kvp in pdf_resources_dictionary.ExtGState.value_y)
                    {
                        int gstate_offset = globals.PDF_Cross_Reference_Table[Convert.ToInt32(kvp.Value[0])].byte_offset * 3;

                        PDF_Graphics_State_Parameter_Dictionary pdf_graphics_state_parameter_dictionary = new PDF_Graphics_State_Parameter_Dictionary(true);

                        Graphics.Graphics_State graphics_state = new Graphics.Graphics_State();

                        graphics_state.getGraphicStateDictionary(ref globals, ref pdf_graphics_state_parameter_dictionary, ref globals.PDF_File.pdf_stream_hexa, gstate_offset);

                        pdf_resources_dictionary.ExtGState.value_z.Add(kvp.Key, pdf_graphics_state_parameter_dictionary);
                ...
                {
                    pdf_resources_dictionary.ExtGState.found = false;
                }


                ///////////////////////////////////////////////////////////////////////
                /// /ColorSpace (dictionary) (see 8.6, "Colour Spaces")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.ColorSpace.key), offset);
                ...
                if (key_idx != -1)
                {
                    ...
                    pdf_resources_dictionary.ColorSpace.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.ColorSpace.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.ColorSpace.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.ColorSpace.value_x)
                    {

                        string resource_name = entry.Key;
                        string[] obj_indirect = entry.Value;
                        int obj_idx = Convert.ToInt32(obj_indirect[0]);

                        PDF_Color_Spaces pdf_color_spaces = new PDF_Color_Spaces();

                        Graphics.Colour_Spaces colour_spaces = new Graphics.Colour_Spaces();

                        int _offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset;

                        colour_spaces.getColourSpace(ref pdf_color_spaces, ref stream_hexa, _offset);

                        pdf_resources_dictionary.ColorSpace.value_y.Add(resource_name, pdf_color_spaces);
                ...
                {
                    pdf_resources_dictionary.ColorSpace.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Pattern (dictionary) (see 8.7, "Patterns")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.Pattern.key), offset);
                ...
                if (key_idx != -1)
                {
                    ...
                    pdf_resources_dictionary.Pattern.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.Pattern.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.Pattern.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.Pattern.value_x)
                    {
                        ...
                        PDF_Patterns pdf_patterns = new PDF_Patterns();

                        Graphics.Patterns patterns = new Graphics.Patterns();

                        int _offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset;

                        patterns.getPatternDictionary(ref pdf_patterns, ref stream_hexa, _offset);

                        pdf_resources_dictionary.Pattern.value_y.Add(resource_name, pdf_patterns);
                ...
                {
                    pdf_resources_dictionary.Pattern.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Shading (dictionary) (see 8.7.4.3, "Shading Dictionaries")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.Shading.key), offset);
                ...
                if (key_idx != -1)
                {
                    ...
                    pdf_resources_dictionary.Shading.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.Shading.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.Shading.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.Shading.value_x)
                    {
                        ...
                        PDF_Shading_Dictionary pdf_shading_dictionary = new PDF_Shading_Dictionary();

                        Graphics.Patterns patterns = new Graphics.Patterns();

                        int _offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset;

                        patterns.getShadingDictionary(ref pdf_shading_dictionary, ref stream_hexa, _offset);

                        pdf_resources_dictionary.Shading.value_y.Add(resource_name, pdf_shading_dictionary);
                ...
                {
                    pdf_resources_dictionary.Shading.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /XObject (dictionary) (see 8.8, "External Objects")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.XObject.key), offset);
                ...
                if (key_idx != -1)
                {
                    pdf_resources_dictionary.XObject.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.XObject.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.XObject.key).Length, ref ERROR_ID, ref ERROR_MSG);

                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.XObject.value_x)
                    {
                        ...
                        PDF_External_Object pdf_external_object = new PDF_External_Object();

                        Graphics.External_Objects external_objects = new Graphics.External_Objects();

                        int _offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset;

                        external_objects.getExternalObject(ref pdf_external_object, ref stream_hexa, _offset);

                        pdf_resources_dictionary.XObject.value_y.Add(resource_name, pdf_external_object);

                    }
                }
                else
                {
                    pdf_resources_dictionary.XObject.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Font (dictionary) (see clause 9, "Text").
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.Font.key), offset);
                ...
                if (key_idx != -1)
                {
                    pdf_resources_dictionary.Font.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.Font.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.Font.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    ...
                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.Shading.value_x)
                    {
                        ...
                        text.getText(ref pdf_text, ref stream_hexa, _offset);

                        pdf_resources_dictionary.Font.value_y.Add(resource_name, pdf_text);

                    }
                }
                else
                {
                    pdf_resources_dictionary.Font.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /ProcSet (array) (see 14.2, "Procedure Sets")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.ProcSet.key), offset);
                ...
                if (key_idx != -1)
                {
                    pdf_resources_dictionary.ProcSet.found = true;

                    Tools.getArrayInDictionaryHex(ref pdf_resources_dictionary.ProcSet.value, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.ProcSet.key).Length, ref ERROR_ID, ref ERROR_MSG);

                }
                else
                {
                    pdf_resources_dictionary.ProcSet.found = false;
                }

                ///////////////////////////////////////////////////////////////////////
                /// /Properties (dictionary) (see 14.6.2, "Property Lists")
                ///////////////////////////////////////////////////////////////////////

                key_idx = stream_hexa.IndexOf(Tools.lineStringToHex(pdf_resources_dictionary.Properties.key), offset);
                ...
                if (key_idx != -1)
                {
                    pdf_resources_dictionary.Properties.found = true;

                    Tools.getIndirectDictionaryArrayWithNamesInDictionaryHex(ref pdf_resources_dictionary.Properties.value_x, ref stream_hexa, key_idx, Tools.lineStringToHex(pdf_resources_dictionary.Properties.key).Length, ref ERROR_ID, ref ERROR_MSG);
                    ...
                    foreach (KeyValuePair<string, string[]> entry in pdf_resources_dictionary.Shading.value_x)
                    {
                        ...
                        PDF_Property_Lists pdf_property_lists = new PDF_Property_Lists();

                        Document_Interchange.Marked_Content marked_content = new Document_Interchange.Marked_Content();

                        int _offset = globals.PDF_Cross_Reference_Table[obj_idx].byte_offset;

                        marked_content.getMarkedContent(ref pdf_property_lists, ref stream_hexa, _offset);

                        pdf_resources_dictionary.Properties.value_y.Add(resource_name, pdf_property_lists);
                    }
                }
                else
                {
                    pdf_resources_dictionary.Properties.found = false;
                }
        ...
        */
            ...
            */
            ...
            public void getNumberTreeNodeDictionary(ref PDF_Number_Tree_Node_Dictionary pdf_number_tree_node_dictionary, ref string stream_hexa, int offset)
            {
        ...
        */
        ...
        public class Extensions_Dictionary
        {
            ...
            */
            ...
            public void getExtensionsDictionary(ref Globals globals, ref List<PDF_Extensions_Dictionary> pdf_extensions_dictionary_list, ref string stream_hexa, int offset)
            {
                /////////////////////////////////////////////////////////////////////////////////////////////////
                /// SET TOOLS AND CONSTANTS
                /////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////
                /// GET EXTENSIONS DICTIONARY SUBSTRING
                /////////////////////////////////////////////////////////////////////////////////////////////////

                string tmp = Tools.substringDelimiterRecurrent(stream_hexa, offset, L_del, R_del);

                int nExtensions = globals.PDF_Extensions_Prefixes.Count;

                for (int i = 0; i < nExtensions; i++)
                {

                    PDF_Extensions_Dictionary pdf_extensions_dictionary = new PDF_Extensions_Dictionary();

                    /////////////////////////////////////////////////////////////////////////////////////////////////
                    /// Try to Find Registered Prefix Key
                    /////////////////////////////////////////////////////////////////////////////////////////////////

                    string key = globals.PDF_Extensions_Prefixes[i].key;

                    int key_idx = tmp.IndexOf(key, offset);
                    ...
                    if (key_idx != -1)
                    {
                        ...
                        string sub_tmp = Tools.substringDelimiterRecurrent(globals.PDF_File.pdf_stream_hexa, key_idx, L_del, R_del);

                        string sub_key = string.Empty;
                        ...
                        pdf_extensions_dictionary.Registered_Prefix.value = key;
                        pdf_extensions_dictionary.Registered_Prefix.found = true;
                        ...
                        sub_key = pdf_extensions_dictionary.Type.key;

                        sub_key_idx = sub_tmp.IndexOf(sub_key, 0);

                        if (sub_key_idx != -1)
                        {
                            pdf_extensions_dictionary.Type.found = true;

                            Tools.getNameInDictionaryHex(ref pdf_extensions_dictionary.Type.value, ref sub_tmp, sub_key_idx, Tools.lineStringToHex(sub_key).Length, ref ERROR_ID, ref ERROR_MSG);
                        }
                        else
                        {
                            pdf_extensions_dictionary.Type.found = false;
                        }
                        ...
                        sub_key = pdf_extensions_dictionary.BaseVersion.key;

                        sub_key_idx = sub_tmp.IndexOf(sub_key, 0);

                        if (sub_key_idx != -1)
                        {
                            pdf_extensions_dictionary.BaseVersion.found = true;

                            Tools.getNameInDictionaryHex(ref pdf_extensions_dictionary.BaseVersion.value, ref sub_tmp, sub_key_idx, Tools.lineStringToHex(sub_key).Length, ref ERROR_ID, ref ERROR_MSG);
                        }
                        else
                        {
                            pdf_extensions_dictionary.BaseVersion.found = false;
                        }
                        ...
                        sub_key = pdf_extensions_dictionary.ExtensionLevel.key;

                        sub_key_idx = sub_tmp.IndexOf(sub_key, 0);

                        if (sub_key_idx != -1)
                        {
                            pdf_extensions_dictionary.ExtensionLevel.found = true;

                            Tools.getIntegerInDictionaryHex(ref pdf_extensions_dictionary.ExtensionLevel.value, ref sub_tmp, sub_key_idx, Tools.lineStringToHex(sub_key).Length, ref ERROR_ID, ref ERROR_MSG);
                        }
                        else
                        {
                            pdf_extensions_dictionary.ExtensionLevel.found = false;
                        }
                        ...
                        pdf_extensions_dictionary_list.Add(pdf_extensions_dictionary);
                    }
